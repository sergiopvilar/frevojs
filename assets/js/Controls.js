...
Module("Retro.Controls", function (Controls) {
  ...
  Controls.fn.updateSongInfo = function (title) {
    this.songInfo.querySelector("[data-current-song]").textContent = "Música atual: " + title;
  };

  Controls.fn.switchToPlayStatus = function () {
    this.playbackControls.querySelector("[data-play]").style.display = "none";
    this.playbackControls.querySelector("[data-pause]").style.display = "inline";
    this.playbackControls.querySelector("[data-stop]").style.display = "inline";
  };

  Controls.fn.switchToStopStatus = function () {
    this.playbackControls.querySelector("[data-play]").style.display = "inline";
